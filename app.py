...
def landing_page():
    ...
    if 'show_more_info' in st.session_state and st.session_state['show_more_info']:
        ...
        <div class="about-section">
            ...
            <strong>🔍 Interactive Analysis Dashboard:</strong> Explore in-depth visual insights with our interactive dashboard. Compare different metrics across countries and regions to understand global livability patterns.
            </p>
            <p>
    ...
    with col1:
        if st.button("🔍 Interactive Analysis Dashboard", key="analyze_button", use_container_width=True):
